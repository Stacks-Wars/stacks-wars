...
No, you cannot move a pawn to a square occupied by another of your own pawns.

**Q: What's the time limit?**
5 seconds to roll, 15 seconds to move. Both have auto-fallbacks on timeout.

**Q: How do ties work?**
Ludo is winner-takes-all — there are no ties. The first player to finish all 4 pawns wins.
