...
- **Fee:** 1% platform fee on winnings

> **Example:** You deposit 100 STX, win, and claim 198 STX (1% fee already deducted)
...
- **Fee:** Varies by sponsor (usually 0%)
...
- **Initial Audit:** Conducted by Certora Labs (Q1 2024)
- **Re-audit Schedule:** Every major version release
- **Audit Reports:** Public on [github.com/stacks-wars/audits](https://github.com/stacks-wars/audits)
...
```
Repository: github.com/stacks-wars/contracts
Files:
  ├─ vault.clar
  ├─ governance.clar
  └─ tests/
...
- Check that the claim window hasn't expired (72 hours)
...
**Q: Can I dispute a game result?**
- Game results are signed by the server and verified on-chain
- Disputes must be filed within the claim window (72 hours)
- Contact support@stacks-wars.com with game ID

**Q: Is the contract verified?**
- Yes! Check [Stacks Explorer](https://explorer.stacks.co) and search our contract address
- Look for the "Verified" badge and audit report links
