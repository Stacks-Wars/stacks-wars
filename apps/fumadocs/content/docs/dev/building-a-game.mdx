...
<Callout type="info">
	[OpenGameArt.org](https://opengameart.org/) is a great source for free,
	open-licensed game sound effects. Search for keywords like "dice roll",
	"piece move", "capture", "buzzer", etc.
</Callout>
