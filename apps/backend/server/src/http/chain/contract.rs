...
const SPONSORED_STX_VAULT_TEMPLATE: &str =
    include_str!("../../../../contract/stacks/contracts/sponsored-stx-vault.clar");
const SPONSORED_FT_VAULT_TEMPLATE: &str =
    include_str!("../../../../contract/stacks/contracts/sponsored-ft-vault.clar");
