...
import {
	useGameLobbies,
	useGameLobbiesTotal,
	useGameLobbiesLoading,
	useGameLobbiesPage,
	useGameLobbiesActions,
} from "@/lib/stores/game-lobbies";
...
export default function GameLobbies({
	...
	const lobbies = useGameLobbies();
	const total = useGameLobbiesTotal();
	const loading = useGameLobbiesLoading();
	const page = useGameLobbiesPage();
	const actions = useGameLobbiesActions();

	useEffect(() => {
		actions.setInitialData(initialLobbies, initialTotal);
		actions.setGameIdentifier(gameIdentifier);
	}, [initialLobbies, initialTotal, gameIdentifier, actions]);
