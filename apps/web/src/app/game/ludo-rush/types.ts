...
/** Safe squares — only the 4 entry points (Ludo Rush has fewer safe squares) */
export const SAFE_SQUARES = [0, 13, 26, 39];
...
export interface LudoRushBoard {
...
export interface LudoRushState {
	/** The board state with all players and pawns */
	board: LudoRushBoard | null;
	...
	lastEvent: LudoRushUIEvent | null;
}
...
export interface LudoRushUIEvent {
	type:
		| "diceRolled"
		| "pawnMoved"
		| "pawnCaptured"
...
// ============================================================================
// Ludo Rush Messages (Server -> Client)
// ============================================================================

export type LudoRushMessage =
	| BoardUpdateMessage
	| TurnMessage
	| DiceRolledMessage
	| MovablePawnsMessage
...
// ============================================================================
// Ludo Rush Game State (for reconnection)
// ============================================================================

export interface LudoRushGameState {
	board: LudoRushBoard;
...
/**
 * Parse raw game state from server into typed LudoRushGameState
 */
export function parseLudoRushGameState(
	raw: unknown
): LudoRushGameState | null {
	if (!raw || typeof raw !== "object") return null;

	const data = raw as Record<string, unknown>;

	return {
		board: data.board as LudoRushBoard,
